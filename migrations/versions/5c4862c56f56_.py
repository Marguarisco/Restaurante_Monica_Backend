...
Revision ID: 5c4862c56f56
Revises: 
Create Date: 2022-01-27 22:41:19.659906
...
def upgrade():
    ...
    op.create_table('satisfacao',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('email', sa.String(length=200), nullable=False),
    sa.Column('atendimento', sa.Integer(), nullable=True),
    sa.Column('sabor_comida', sa.Integer(), nullable=True),
    sa.Column('limpeza_organizacao', sa.Integer(), nullable=True),
    sa.Column('preco', sa.Integer(), nullable=False),
    sa.Column('velocidade_servico', sa.Integer(), nullable=True),
    ...
    sa.Column('data_criacao', sa.DateTime(), nullable=True),
    sa.Column('ultima_modificacao', sa.String(length=8), nullable=True),
    ...
    op.create_table('data_validade',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('quantidade', sa.Integer(), nullable=True),
    sa.Column('data_criacao', sa.DateTime(), nullable=True),
    sa.Column('data', sa.String(length=8), nullable=True),
    sa.Column('produto_id', sa.Integer(), nullable=False),
    sa.Column('estoque_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['estoque_id'], ['estoque.id'], ),
    sa.ForeignKeyConstraint(['produto_id'], ['produto.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('estoque_id'),
    sa.UniqueConstraint('produto_id')
    )
...
def downgrade():
    ...
    op.drop_table('data_validade')
    op.drop_table('pedido')
    op.drop_table('estoque')
    op.drop_table('satisfacao')
